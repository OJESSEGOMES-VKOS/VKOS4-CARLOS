...
3. **Posicionamento ou produto?** → **VKOS01** (manifesto), **VKOS02** (produto) e **VKOS09** (topo de funil).
...
**Achou um print que você quer copiar a cara?** Jogue a imagem em `identidade/inspiracoes/` e rode
o **`/modelo`**. Ele lê a referência, tira dela a estrutura (grade, hierarquia de texto, ritmo dos
slides), executa tudo com as SUAS cores, gera o `modelo-<slug>.html`, acrescenta a linha dele numa
seção "Seus modelos" aqui neste arquivo e renderiza uma amostra pra você conferir. A referência dá
a estrutura, a sua marca dá a cor.
