...
instalado (`npm ci --ignore-scripts`, e se faltar o navegador, `npm run setup`). Se sua
...
- **Texto na voz do negócio, concreto, não genérico.** Cidade com nome (a sua, do bloco 3 do
  Cérebro), serviço com nome (terapia de casal, consultoria/palestra), dor real. Nada de promessa
  subjetiva.
