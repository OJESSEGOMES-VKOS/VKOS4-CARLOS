...
- **Projetos.** Liste as pastas de `projetos/`. Cada uma tem um `LEIA.md` na raiz? Ele ainda
  descreve o estado real, ou o projeto andou e o `LEIA.md` ficou pra trás? Projeto sem `LEIA.md`
  em dia é o contexto mais fácil de perder.
